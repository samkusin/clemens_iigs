...
static void _sg_all_convert_to_rgba(void* dest_pixels, int dest_w, int dest_h, void* src_pixels,
                             int src_pitch, int src_r, int src_g, int src_b, int src_a) {
...
static void _sg_d3d11_query_image_pixels(_sg_image_t* img, void* pixels) {
    ...
    switch (staging_desc.Format) {
        case DXGI_FORMAT_B8G8R8A8_UNORM:
            _sg_all_convert_to_rgba(pixels, img->cmn.width, img->cmn.height,  msr.pData, msr.RowPitch, 2, 1, 0, 3);
            break;
        case DXGI_FORMAT_B8G8R8X8_UNORM:
            _sg_all_convert_to_rgba(pixels, img->cmn.width, img->cmn.height,  msr.pData, msr.RowPitch, 2, 1, 0, -1);
            break;
        default:
            break;
    }
