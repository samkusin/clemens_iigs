...
#define CLEM_IWM_FLAG_MASK_PRE_STEP_CLEARED                                    \
  (CLEM_IWM_FLAG_WRPROTECT_SENSE + CLEM_IWM_FLAG_READ_DATA +                   \
   CLEM_IWM_FLAG_READ_DATA_FAKE + CLEM_IWM_FLAG_PULSE_HIGH)
...
void clem_disk_read_and_position_head_35(struct ClemensDrive *drive,
