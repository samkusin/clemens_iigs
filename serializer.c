...
struct ClemensSerializerRecord kRTC[] = {
    ...
    CLEM_SERIALIZER_RECORD_DURATION(struct ClemensDeviceRTC,
                                    xfer_latency_duration),
    ...
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceRTC,
                                 kClemensSerializerTypeUInt8, bram, 256, 0),
...
struct ClemensSerializerRecord kADBKeyboard[] = {
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceKeyboard,
                                 kClemensSerializerTypeUInt8, keys,
                                 CLEM_ADB_KEYB_BUFFER_LIMIT, 0),
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceKeyboard,
                                 kClemensSerializerTypeUInt8, states,
    ...
    CLEM_SERIALIZER_RECORD_UINT8(struct ClemensDeviceKeyboard,
                                 last_a2_key_down),
...
struct ClemensSerializerRecord kGameport[] = {
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceGameport,
                                 kClemensSerializerTypeUInt8, paddle, 4, 0),
...
struct ClemensSerializerRecord kDebugger[] = {
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceDebugger,
                                 kClemensSerializerTypeUInt32, ioreg_read_ctr,
                                 256, 0),
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceDebugger,
                                 kClemensSerializerTypeUInt32, ioreg_write_ctr,
                                 256, 0),
    CLEM_SERIALIZER_RECORD_EMPTY()};

struct ClemensSerializerRecord kAudio[] = {
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceAudio,
    ...
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceAudio,
                                 kClemensSerializerTypeUInt8, doc_reg, 256, 0),
...
struct ClemensSerializerRecord kSCC[] = {
    ...
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceSCC,
                                 ...
                                 0),
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceSCC,
                                 kClemensSerializerTypeUInt8, serial, 2, 0),
...
struct ClemensSerializerRecord kIWM[] = {
    ...
    CLEM_SERIALIZER_RECORD_CLOCKS(struct ClemensDeviceIWM,
                                  last_write_clocks_ts),
...
struct ClemensSerializerRecord kADB[] = {
    ...
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceADB,
                                 kClemensSerializerTypeUInt16, mouse_reg, 4, 0),
    ...
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceADB,
                                 kClemensSerializerTypeUInt8, cmd_data, 16, 0),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensDeviceADB, keyb,
                                  struct ClemensDeviceKeyboard, kADBKeyboard),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensDeviceADB, mouse,
                                  struct ClemensDeviceMouse, kADBMouse),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensDeviceADB, gameport,
                                  struct ClemensDeviceGameport, kGameport),
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDeviceADB,
                                 kClemensSerializerTypeUInt8, ram, 256, 0),
...
struct ClemensSerializerRecord kMMIO[] = {
    ...
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensMMIO, vgc, struct ClemensVGC,
                                  kVGC),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensMMIO, dev_rtc,
                                  struct ClemensDeviceRTC, kRTC),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensMMIO, dev_adb,
                                  struct ClemensDeviceADB, kADB),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensMMIO, dev_timer,
                                  struct ClemensDeviceTimer, kTimer),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensMMIO, dev_debug,
                                  struct ClemensDeviceDebugger, kDebugger),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensMMIO, dev_audio,
                                  struct ClemensDeviceAudio, kAudio),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensMMIO, dev_iwm,
                                  struct ClemensDeviceIWM, kIWM),
    CLEM_SERIALIZER_RECORD_OBJECT(struct ClemensMMIO, dev_scc,
                                  struct ClemensDeviceSCC, kSCC),
...
struct ClemensSerializerRecord kDrive[] = {
    CLEM_SERIALIZER_RECORD_CUSTOM(struct ClemensDrive, disk,
    ...
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensDrive,
                                 kClemensSerializerTypeUInt8, random_bits,
...
struct ClemensSerializerRecord kDriveBay[] = {
    CLEM_SERIALIZER_RECORD_ARRAY_OBJECTS(struct ClemensDriveBay, slot5, 2,
                                         struct ClemensDrive, kDrive),
    CLEM_SERIALIZER_RECORD_ARRAY_OBJECTS(struct ClemensDriveBay, slot6, 2,
                                         struct ClemensDrive, kDrive),
    CLEM_SERIALIZER_RECORD_EMPTY()};
...
struct ClemensSerializerRecord kMachine[] = {
    ...
    CLEM_SERIALIZER_RECORD_OBJECT(ClemensMachine, mmio, struct ClemensMMIO,
                                  kMMIO),
    CLEM_SERIALIZER_RECORD_OBJECT(ClemensMachine, active_drives,
...
struct ClemensSerializerRecord kNibbleDisk[] = {
    ...
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensNibbleDisk,
                                 kClemensSerializerTypeUInt8, meta_track_map,
                                 CLEM_DISK_LIMIT_QTR_TRACKS, 0),
    CLEM_SERIALIZER_RECORD_ARRAY(
        struct ClemensNibbleDisk, kClemensSerializerTypeUInt32,
        track_byte_offset, CLEM_DISK_LIMIT_QTR_TRACKS, 0),
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensNibbleDisk,
                                 kClemensSerializerTypeUInt32, track_byte_count,
                                 CLEM_DISK_LIMIT_QTR_TRACKS, 0),
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensNibbleDisk,
                                 kClemensSerializerTypeUInt32, track_bits_count,
                                 CLEM_DISK_LIMIT_QTR_TRACKS, 0),
    CLEM_SERIALIZER_RECORD_ARRAY(struct ClemensNibbleDisk,
                                 kClemensSerializerTypeUInt8, track_initialized,
                                 CLEM_DISK_LIMIT_QTR_TRACKS, 0),
    CLEM_SERIALIZER_RECORD_EMPTY()};

static unsigned clemens_serialize_custom(mpack_writer_t *writer, void *ptr,
                                         unsigned sz, unsigned record_id);

unsigned
clemens_serialize_record(mpack_writer_t *writer, uintptr_t data_adr,
  ...
  case kClemensSerializerTypeCustom:
    sz = clemens_serialize_custom(writer, (void *)(data_adr + record->offset),
                                  record->size, record->param);
    break;
  }
  return sz;
}
...
unsigned clemens_serialize_array(mpack_writer_t *writer, uintptr_t data_adr,
  ...
  */
  ...
  for (idx = 0; idx < record->size; ++idx) {
    ...
    array_value_adr +=
        clemens_serialize_record(writer, array_value_adr, &value_record);
  }
...
static void
clemens_serialize_records(mpack_writer_t *writer, uintptr_t data_adr,
                          const struct ClemensSerializerRecord *record) {
...
unsigned
clemens_serialize_object(mpack_writer_t *writer, uintptr_t data_adr,
                         const struct ClemensSerializerRecord *record) {
...
mpack_writer_t *clemens_serialize_machine(mpack_writer_t *writer,
  ...
  */
  for (idx = 0; idx < 256; ++idx) {
    ...
    if (machine->fpi_bank_used[idx]) {
      ...
      mpack_write_bin(writer, (char *)machine->fpi_bank_map[idx],
                      CLEM_IIGS_BANK_SIZE);
    }
  }
...
static unsigned clemens_unserialize_custom(mpack_reader_t *reader, void *ptr,
                                           unsigned sz, unsigned record_id,
                                           ClemensSerializerAllocateCb alloc_cb,
                                           void *context);

unsigned
clemens_unserialize_record(mpack_reader_t *reader, uintptr_t data_adr,
                           const struct ClemensSerializerRecord *record,
                           ClemensSerializerAllocateCb alloc_cb,
                           void *context) {
  union ClemensSerializerVariant variant;
  ...
  case kClemensSerializerTypeBlob:
    ...
    *(uint8_t **)(data_adr + record->offset) = variant.blob;
    ...
    break;
  case kClemensSerializerTypeArray:
    sz = clemens_unserialize_array(reader, data_adr + record->offset, record,
                                   alloc_cb, context);
    break;
  case kClemensSerializerTypeObject:
    sz = clemens_unserialize_object(reader, data_adr + record->offset, record,
                                    alloc_cb, context);
    break;
  case kClemensSerializerTypeCustom:
    sz = clemens_unserialize_custom(reader, (void *)(data_adr + record->offset),
                                    record->size, record->param, alloc_cb,
                                    context);
    break;
  }
  return sz;
...
static void
clemens_unserialize_records(mpack_reader_t *reader, uintptr_t data_adr,
                            const struct ClemensSerializerRecord *record,
                            ClemensSerializerAllocateCb alloc_cb,
                            void *context) {
  char key[64];
...
static unsigned clemens_unserialize_custom(mpack_reader_t *reader, void *ptr,
  ...
  case CLEM_SERIALIZER_CUSTOM_RECORD_NIBBLE_DISK:
    nib_disk = (struct ClemensNibbleDisk *)ptr;
    clemens_unserialize_records(reader, (uintptr_t)nib_disk, &kNibbleDisk[0],
                                alloc_cb, context);
    mpack_expect_cstr(reader, key, sizeof(key));
    if (mpack_expect_bool(reader)) {
      mpack_expect_cstr(reader, key, sizeof(key));
...
unsigned
clemens_unserialize_object(mpack_reader_t *reader, uintptr_t data_adr,
                           const struct ClemensSerializerRecord *record,
                           ClemensSerializerAllocateCb alloc_cb,
                           void *context) {
...
mpack_reader_t *
clemens_unserialize_machine(mpack_reader_t *reader, ClemensMachine *machine,
                            ClemensSerializerAllocateCb alloc_cb,
                            void *context) {
  struct ClemensSerializerRecord root;
  union ClemensSerializerVariant variant;
  ...
  if (clemens_unserialize_object(reader, (uintptr_t)data_adr, &root, alloc_cb,
                                 context) == CLEM_SERIALIZER_INVALID_RECORD) {
    return NULL;
  }
