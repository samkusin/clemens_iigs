...
static inline void _cpu_p_flags_n_data(struct Clemens65C816 *cpu,
                                       uint8_t data) {
  if (data & 0x80) {
...
static inline void _cpu_p_flags_n_data_16(struct Clemens65C816 *cpu,
                                          uint16_t data) {
  if (data & 0x8000) {
    cpu->regs.P |= kClemensCPUStatus_Negative;
  } else {
...
static inline void _cpu_p_flags_z_data(struct Clemens65C816 *cpu,
                                       uint8_t data) {
  if (data) {
...
static inline void _cpu_p_flags_z_data_16(struct Clemens65C816 *cpu,
                                          uint16_t data) {
  if (data) {
    cpu->regs.P &= ~kClemensCPUStatus_Zero;
  } else {
...
static inline void _cpu_p_flags_n_z_data(struct Clemens65C816 *cpu,
                                         uint8_t data) {
  _cpu_p_flags_n_data(cpu, data);
  _cpu_p_flags_z_data(cpu, data);
}

static inline void _cpu_p_flags_n_z_data_16(struct Clemens65C816 *cpu,
                                            uint16_t data) {
  _cpu_p_flags_n_data_16(cpu, data);
  _cpu_p_flags_z_data_16(cpu, data);
}

static inline void _cpu_p_flags_n_z_data_816(struct Clemens65C816 *cpu,
                                             uint16_t data, bool is8) {
  if (is8) {
...
static inline void _clem_write_16(ClemensMachine *clem, uint16_t data,
...
static inline void _clem_read_16(ClemensMachine *clem, uint16_t *data16,
                                 uint16_t adr, uint8_t bank, uint8_t flags) {
...
static inline void _clem_read_pba(ClemensMachine *clem, uint8_t *data,
                                  uint16_t *pc) {
  clem_read(clem, data, (*pc)++, clem->cpu.regs.PBR, CLEM_MEM_FLAG_PROGRAM);
}

static inline void _clem_read_pba_16(ClemensMachine *clem, uint16_t *data16,
                                     uint16_t *pc) {
  uint8_t tmp_data;
...
static inline void _clem_read_pba_816(ClemensMachine *clem, uint16_t *out,
                                      uint16_t *pc, bool is8) {
  uint8_t tmp_data;
  _clem_read_pba(clem, &tmp_data, pc);
  *out = tmp_data;
  if (!is8) {
...
static inline void _clem_read_data_816(ClemensMachine *clem, uint16_t *out,
                                       uint16_t addr, uint8_t dbr, bool is8) {
  uint8_t tmp_data;
...
static inline void _clem_read_data_indexed_816(ClemensMachine *clem,
                                               uint16_t *out, uint16_t addr,
                                               uint16_t index, uint8_t dbr,
                                               bool is_data_8,
                                               bool is_index_8) {
  uint8_t dbr_actual;
...
static inline void _clem_opc_push_reg_816(ClemensMachine *clem, uint16_t data,
                                          bool is8) {
  struct Clemens65C816 *cpu = &clem->cpu;
  _clem_cycle(clem, 1);
  if (!is8) {
    clem_write(clem, (uint8_t)(data >> 8), cpu->regs.S, 0x00,
               CLEM_MEM_FLAG_DATA);
    _cpu_sp_dec(cpu);
  }
...
static inline void _clem_opc_pull_reg_816(ClemensMachine *clem, uint16_t *data,
                                          bool is8) {
  struct Clemens65C816 *cpu = &clem->cpu;
  uint8_t data8;
  _clem_cycle(clem, 2);
 ...
 */
static inline void _clem_read_pba_mode_imm_816(ClemensMachine *clem,
                                               uint16_t *imm, uint16_t *pc,
                                               bool is8) {
  _clem_read_pba_816(clem, imm, pc, is8);
}

static inline void _clem_read_pba_mode_abs(ClemensMachine *clem, uint16_t *addr,
                                           uint16_t *pc) {
  _clem_read_pba_16(clem, addr, pc);
}

static inline void _clem_read_pba_mode_absl(ClemensMachine *clem,
                                            uint16_t *addr, uint8_t *dbr,
                                            uint16_t *pc) {
  _clem_read_pba_16(clem, addr, pc);
  _clem_read_pba(clem, dbr, pc);
}

static inline void _clem_read_pba_mode_dp(ClemensMachine *clem,
                                          uint16_t *eff_addr, uint16_t *pc,
...
static inline void
_clem_read_pba_mode_dp_indirect(ClemensMachine *clem, uint16_t *eff_addr,
...
static inline void _clem_read_pba_mode_dp_indirectl(
    ClemensMachine *clem, uint16_t *eff_addr, uint8_t *eff_bank, uint16_t *pc,
...
static inline void _clem_read_pba_mode_stack_rel(ClemensMachine *clem,
...
static inline void _clem_read_pba_mode_stack_rel_indirect(ClemensMachine *clem,
                                                          uint16_t *addr,
                                                          uint16_t *pc,
                                                          uint8_t *offset) {
  uint16_t tmp_addr;
...
static inline void _cpu_adc(struct Clemens65C816 *cpu, uint16_t value,
                            bool is8) {
  uint32_t adc;
  uint8_t p;
...
static inline void _cpu_adc_bcd(struct Clemens65C816 *cpu, uint16_t value,
                                bool is8) {
  ...
  */
  ...
  if (is8) {
    ...
    if (adc > 0x9ff)
      adc += 0x600;
    carry = adc > 0xfff;
    adc = (cpu->regs.A & 0xf000) + (value & 0xf000) + (carry << 12) +
          (adc & 0xfff);
    p = cpu->regs.P;
    if ((cpu->regs.A ^ adc) & (value ^ adc) & 0x8000)
      p |= kClemensCPUStatus_Overflow;
...
static inline void _cpu_sbc(struct Clemens65C816 *cpu, uint16_t value,
                            bool is8) {
...
static inline void _cpu_sbc_bcd(struct Clemens65C816 *cpu, uint16_t value,
                                bool is8) {
  /* note, invalid BCD should still function according to specific rules. see
     https://math.stackexchange.com/questions/945320/why-do-we-add-6-in-bcd-addition
  */
...
static inline void _cpu_asl(struct Clemens65C816 *cpu, uint16_t *value,
                            bool is8) {
...
static inline void _cpu_rol(struct Clemens65C816 *cpu, uint16_t *value,
                            bool is8) {
  uint8_t p = cpu->regs.P;
  bool next_carry;
  if (is8) {
...
static inline void _cpu_lsr(struct Clemens65C816 *cpu, uint16_t *value,
                            bool is8) {
  uint8_t p = cpu->regs.P;
  if (is8) {
    uint8_t v = (uint8_t)(*value);
...
static inline void _cpu_ror(struct Clemens65C816 *cpu, uint16_t *value,
                            bool is8) {
  uint8_t p = cpu->regs.P;
...
static inline void _cpu_cmp(struct Clemens65C816 *cpu, uint16_t reg,
                            uint16_t value, bool is8) {
  uint32_t cmp;
  uint8_t p = cpu->regs.P;
  if (is8) {
    value = value & 0xff;
...
static inline void _cpu_and(struct Clemens65C816 *cpu, uint16_t value,
                            bool is8) {
  uint16_t and;
  if (is8) {
    value = value & 0xff;
...
static inline void _cpu_eor(struct Clemens65C816 *cpu, uint16_t value,
                            bool is8) {
  uint16_t eor;
  if (is8) {
    value = value & 0xff;
...
static inline void _cpu_ora(struct Clemens65C816 *cpu, uint16_t value,
                            bool is8) {
  uint16_t ora;
  if (is8) {
    value = value & 0xff;
...
static inline void _cpu_bit(struct Clemens65C816 *cpu, uint16_t value,
                            bool is8) {
  if (is8) {
    uint8_t v = (uint8_t)(value);
...
static inline void _cpu_dec(struct Clemens65C816 *cpu, uint16_t *value,
                            bool is8) {
  if (is8) {
    uint8_t v = (uint8_t)(*value);
    --v;
...
static inline void _cpu_lda(struct Clemens65C816 *cpu, uint16_t value,
                            bool is8) {
  if (is8) {
...
static inline void _cpu_ldxy(struct Clemens65C816 *cpu, uint16_t *reg,
                             uint16_t value, bool is8) {
  if (is8) {
    _cpu_p_flags_n_z_data(cpu, (uint8_t)value);
...
static inline void _cpu_trb(struct Clemens65C816 *cpu, uint16_t *value,
                            bool is8) {
  if (is8) {
    uint8_t v = (uint8_t)(*value);
    uint8_t a = (uint8_t)(cpu->regs.A);
...
static inline void _cpu_tsb(struct Clemens65C816 *cpu, uint16_t *value,
                            bool is8) {
  if (is8) {
    uint8_t v = (uint8_t)(*value);
    uint8_t a = (uint8_t)(cpu->regs.A);
...
static inline void _clem_write_816(ClemensMachine *clem, uint16_t value,
                                   uint16_t addr, uint8_t dbr, bool is8) {
  if (is8) {
...
static inline void _clem_write_indexed_816(ClemensMachine *clem, uint16_t value,
                                           uint16_t addr, uint16_t index,
                                           uint8_t dbr, bool is_data_8,
                                           bool is_index_8) {
  uint16_t eff_index = is_index_8 ? (index & 0xff) : index;
  uint16_t eff_addr = addr + eff_index;
  uint8_t dbr_actual;
...
static inline void _clem_branch(ClemensMachine *clem, uint16_t *pc,
                                int8_t offset, bool do_branch) {
  if (!do_branch)
    return;
